        ...
        <div class="container">
            <h1 class="my-md-5 my-4"><?php echo $pageData['material']['name_material']; ?></h1>
            <div class="row mb-3">
                <div class="col-lg-6 col-md-8">
                    <div class="d-flex text-break">
                        <p class="col fw-bold mw-25 mw-sm-30 me-2">Авторы</p>
                        <p class="col"><?php echo $pageData['material']['autor']; ?></p>
                    </div>
                    <div class="d-flex text-break">
                        <p class="col fw-bold mw-25 mw-sm-30 me-2">Тип</p>
                        <p class="col"><?php echo $pageData['material']['name_type']; ?></p>
                    </div>
                    <div class="d-flex text-break">
                        <p class="col fw-bold mw-25 mw-sm-30 me-2">Категория</p>
                        <p class="col"><?php echo $pageData['material']['name_category']; ?></p>
                    </div>
                    <div class="d-flex text-break">
                        <p class="col fw-bold mw-25 mw-sm-30 me-2">Описание</p>
                        <p class="col"><?php echo $pageData['material']['description']; ?></p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <form method="post">
                        ...
                        <div class="input-group mb-3">
                            <select class="form-select" id="selectAddTag" aria-label="Добавьте тег" name="tag">
                                <?php foreach ($pageData['material']['tags_all'] as $value) { ?>
                    ...
                    <ul class="list-group mb-4">
                        <?php if (!empty($pageData['material']['tags_material'])) { ?>
                        <?php foreach ($pageData['material']['tags_material'] as $value) { ?>
                        <li class="list-group-item list-group-item-action d-flex justify-content-between">
                            <a href="#" class="me-3">
                                <?=  $value['name']; ?>
                            </a>
                            <a href="/materials/deleteTagFromMaterial/<?= $value['id']; ?>" class="text-decoration-none">
